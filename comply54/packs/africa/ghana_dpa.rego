...
#   s.17-26 — Eight data protection principles
#   s.18(2) — Cross-border transfer (adequacy requirement; Act 843 has no
#              dedicated outbound-transfer section — s.18(2) is the closest)
#   s.28-30 — Data security safeguards
#   s.31    — Breach notification to DPC and data subjects
