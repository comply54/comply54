...
| Pack versions | `c54_pack_versions` | Version of each policy pack at evaluation time |
...
#   pack_versions    nigeria/ndpa=1.0.0, nigeria/cbn=1.0.0, nigeria/nfiu-aml=1.1.0, ...
#
#   input match      YES
```
...
class ReceiptPayload:
    ...
    pack_versions: dict[str, str]  # {pack_id: version} for every evaluated pack
```
