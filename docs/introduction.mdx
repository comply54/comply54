---
title: Introduction
description: African AI governance compliance — enforcement engine and sector packs for NDPA, CBN, KDPA, POPIA and 15+ African regulatory frameworks.
---
...
<CardGroup cols={2}>
  ...
  <Card title="19 policy packs" icon="scale-balanced">
    NDPA, CBN, KDPA, POPIA, Ghana DPA, Rwanda DPA, Egypt PDPL and 12 more — all with exact regulatory citations.
  </Card>
  <Card title="Sector packs" icon="building-columns">
    `NigeriaFintechCompliance`, `KenyaFintechCompliance`, `PanAfricanFintechCompliance` — pre-composed for your vertical.
  </Card>
...
| Region | Frameworks |
|--------|-----------|
| Nigeria | NDPA 2023, CBN Transaction Controls, BVN/NIN Framework, NFIU/MLPPA 2022 |
